...
#include <time.h>
#include <sys/time.h>
#include "yolov2_reorg_rsc_0_3_NTP.h"
...
int main( int argc, char *argv[])
{
	...
	data_num = get_file_size("syn_kernel_w_T_i16rc_srcb.bin");
	int16_t *kernel_w = (int16_t *)malloc(data_num);
	printf("read weight byte_num = %d\n", read_binfile_flt32_rb((float *)kernel_w, "syn_kernel_w_T_i16rc_srcb.bin", data_num/4));
